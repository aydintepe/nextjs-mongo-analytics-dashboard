...
import styles from "./BreakdownCounterChart.module.scss";
...
const DIMENSION_CONFIGS: Record<ChartDimension, ChartDimensionConfig> = {
  total_counter: {
    title: "Total Counter",
    fetchData: fetchTotalCounter,
    getData: totalCounterSelectors.selectAll,
    getValue: ({ counter }: any) => counter,
...
export default function BreakdownCounterChart({
  className,
