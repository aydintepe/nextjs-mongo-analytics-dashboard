...
import { fetchCatalogItems } from "@/store/catalogItems/catalog-items-jp.slice";
import { catalogItemsSelectors } from "@/store/catalogItems/catalog-items-jp.selectors";
...
export function CatalogItemsTableJP({ className }: CatalogItemsTableProps) {
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <h2 className={styles.title}>Catalog Items Japan</h2>
      </div>
