...
import { fetchCatalogItems } from "@/store/catalogItems/catalog-items-au.slice";
import { catalogItemsSelectors } from "@/store/catalogItems/catalog-items-au.selectors";
...
export function CatalogItemsTableAU({ className }: CatalogItemsTableProps) {
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <h2 className={styles.title}>Catalog Items Australia</h2>
      </div>
