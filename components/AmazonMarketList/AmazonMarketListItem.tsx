...
import styles from "./AmazonMarketListItem.module.css";
...
export interface AmazonMarketListItemProps {
...
export default function AmazonMarketListItem({
  stats,
  totalStats,
  className,
}: AmazonMarketListItemProps) {
  return (
    <div className={classNames(className, styles.row)}>
      <div className={styles.row}>
        <div className={styles.icon}>{getPlatformIcon(stats.platform)}</div>
        <div className={styles.column}>
          <h3 className={styles.title} data-testid="AmazonMarketListItem_title">
            {stats.platform}
          </h3>
          <span className={styles.note} data-testid="AmazonMarketListItem_note">
