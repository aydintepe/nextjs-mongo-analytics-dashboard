...
import { fetchCatalogItems } from "@/store/catalogItems/catalog-items-uk.slice";
import { catalogItemsSelectors } from "@/store/catalogItems/catalog-items-uk.selectors";
...
export function CatalogItemsTableUK({ className }: CatalogItemsTableProps) {
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <h2 className={styles.title}>Catalog Items United Kingdom</h2>
      </div>
